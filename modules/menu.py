...
class main(object):
  def about(self):
    while True:
      ab()
      back = input(" \033[0;33m\033[4;mInfinitiServer\033[00m\033[01;31m > \033[1;36m")
  ...
  def uninstall(self):
    while True:
      Mylogo()
      ask = input("\n\033[1;33m Do you want to uninstall InfinitiServer [\033[01;32mY/n\033[01;33m] >> \033[1;36m")
      if ask == "n" or ask == "N":
        break
      elif ask == "Y" or ask == "y":
  ...
  def menu(self):
    while True:
      logo()
      Tool = input(" \033[0;33m\033[4;mInfinitiServer\033[00m\033[01;31m > \033[1;36m")
      if Tool == "1":
        default_s()
      elif Tool == "2":
        default_h()
        ...
        self.about()
      elif Tool == "Uninstall InfinitiServer" or Tool == "uninstall infinitiserver" or Tool == "rm -T":
        self.uninstall()
      elif Tool == "exit":
        exit()
      elif Tool == "x":
