...
if len(sys.argv)>1:
  ...
  print ("use : infinitiserver --help  for more information")
  sys.exit()
...
if sys.argv[1]=="-s":
  ...
  if system=="ubuntu":
    os.system("sudo python3 .InfinitiServer.py")
  else:
     os.system("python3 .InfinitiServer.py")

elif sys.argv[1]=="--help" or sys.argv[1]=="-help" or sys.argv[1]=="help":
  print ("")
  print ("Usage: infinitiserver [command]... [arguments]...")
  print ("")
  print (" Commands:")
  ...
  print (" update                                 update InfinitiServer.")
  print (" rm -t                                  uninstall InfinitiServer.")
  print (" start                                  start InfinitiServer menu.")
  print ("")
